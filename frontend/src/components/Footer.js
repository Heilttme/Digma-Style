      ...
      <div className='footer-wrapper'>
        <div className='columns'>
          <div className='first-col col'>
            <h2>{t("ShopFooter")}</h2>
            <ul>
              <li><a href='#'>{t("Browse")}</a></li>
              <li><a href='#'>{t("SignIn")}</a></li>
              <li><a href='#'>{t("SignUp")}</a></li>
            </ul>
          </div>
        ...
        <div className='copyright'>
          <p>© Copyright 2022 Digma Style. {t("AllRightsReserved")}.</p>
        </div>
      </div>
    </div>
  )
